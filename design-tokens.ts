...
export const spacing = {
  // Common spacing values (in pixels, convert to rem as needed)
  xs: '4px',
  sm: '8px',
  md: '12px',
  lg: '16px',
...
// Button Styles (from Flutter theme)
...
// Input Styles (from Flutter theme)
export const inputs = {
  padding: {
    horizontal: '16px',
    vertical: '12px',
...
// Card Styles (from Flutter theme)
export const cards = {
  borderRadius: borderRadius.md,
...
export const designSystem = {
  ...
  principles: {
    ...
    borderRadius: '10-12px for buttons/cards',
    buttonPadding: '24px horizontal, 12px vertical',
  },
} as const;
